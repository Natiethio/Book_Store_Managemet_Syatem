...
?>
   <div class="heading" style="background-image:url('images/backgd3.jpg');margin-top:50px">
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <p>already have an account? <a style="color:orangered" href="login.php">login now</a></p>
   </form>
